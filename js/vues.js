...
function produit(){
    rep='<div class="row" id="pub1" >'+
        ...
        '<strong>Attention !</strong>Vous devez choisir au moins un champ du gauche!'+
        ...
        '<input type="text" class="form-control greenBorder py-4" id="cout"'+
        ...
        '<input type="text" class="form-control greenBorder py-4" id="majoration"'+
        'onKeyPress="return acceptNum(event)"'+
        ...
        '<input type="text" class="form-control greenBorder py-4" id="prix"'+
        'onKeyPress="return acceptNum(event)"'+
        'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2);" placeholder="">'+
        '</div>'+
        '<div class="col-lg-5 form-group">'+
        ...
        '<input type="text" class="form-control greenBorder py-4" id="marge"'+
        'onKeyPress="return acceptNum(event)"'+
        'onchange="this.value=eedisplayPercentND(eeparsePercent(this.value),2);" placeholder="">'+
        '</div>'+
        ...
        '</div>'+
        '</form>'+
        '<p class="px-sm-4 pt-sm-4 text-justify ">Cette outil vous permettra calculer le prix de vente, la majoration de prix en % ou le marge bruit en %.'+
        ...
        '<p class="px-sm-4 pb-sm-4 text-justify mb-5 ">Vous devez remplir deux champs, un champ doit être une des'+
        'options de gauche.</p>'+
        ''+
        '<!-- Copyright -->'+
...
function main(){
    ...
    '<input type="text" class="form-control greenBorder py-4" id="coutm"'+
    'onKeyPress="return acceptNum(event)"'+
    ...
    '<input type="text" class="form-control greenBorder py-4" id="heures"'+
    'onKeyPress="return acceptNum(event)"'+
    ...
    '  Si vous voulez calculer le prix de vente vous devrez écrire la majoration de prix en %.'+
    '  Si vous voulez savoir la majoration de prix en % vous devrez entrer le prix de vente.</p>'+
    '<p class="px-sm-4 pb-sm-4 text-justify mb-5 ">Vous pouvez changer le coût de main d\'œuvre par heure ou nombre de heures pour calculer le coût.'+
    '  Vous devez remplir un champs de droit pour calculer les autres.</p>'+
    ''+
    '<!-- Copyright -->'+
    '<div class="footer-copyright text-left mt-5 mb-0"><small>© 2019 Copyright:'+
    '<a href="javascript:void(0);" onclick="location.reload();"'+
...
function entreprise(){
    ...
    '<input type="text" class="form-control greenBorder py-2" id="ventes"'+
    'onKeyPress="return acceptNum(event)"'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="autres"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-1"></div>'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="retours"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-5 form-group">'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="revenus"'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="cout"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-5">'+
    '<label for="entretien" class="col-form-label d-flex justify-content-start mb-0 pb-0">Coût d\'Entretien</label>'+
    '<input type="text" class="form-control greenBorder py-2" id="entretien"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-1"></div>'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="salaires"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-5 ">'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="amortissement"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-md-1"></div>'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="loyer"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-5 ">'+
    '<label for="impots" class="col-form-label d-flex justify-content-start mb-0 pb-0">Impôts et licences</label>'+
    '<input type="text" class="form-control greenBorder py-2" id="impots"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-1"></div>'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="services"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-5 ">'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="interets"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-md-1"></div>'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="web"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-5 ">'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="creances"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-1"></div>'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="assurances"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-5">'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="assistance"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-md-1"></div>'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="pub"'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2); calcul3();" placeholder="">'+
    '</div>'+
    '<div class="col-lg-5 form-group">'+
    '<label for="despenses" class="col-form-label d-flex justify-content-start mb-0 pb-0"'+
    'title="Comptables, avocats, spécialistes en technologie de l\'information, etc.">Total dêpenses</label>'+
    '<input type="text" class="form-control greenBorder py-2" id="despenses" readonly'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2);" placeholder="">'+
    '</div>'+
    '<div class="col-md-1"></div>'+
    ...
    '<input type="text" class="form-control greenBorder py-2" id="profit" readonly'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2);" placeholder="">'+
    '</div>'+
    '<div class="col-lg-4 ">'+
    '<label for="majoration" class="col-form-label d-flex justify-content-start mb-0 pb-0">Majoration en %</label>'+
    '<input type="text" class="form-control greenBorder py-2" id="majoration" readonly'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2);" placeholder="">'+
    '</div>'+
    '<div class="col-lg-4 ">'+
    '<label for="marge" class="col-form-label d-flex justify-content-start mb-0 pb-0">Marge brute en %</label>'+
    '<input type="text" class="form-control greenBorder py-2" id="marge" readonly'+
    'onKeyPress="return acceptNum(event)"'+
    'onchange="this.value=eedisplayFloatNDTh(eeparseFloatTh(this.value),2);" placeholder="">'+
    '</div>'+
    '</div>'+
